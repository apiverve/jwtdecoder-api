...
namespace APIVerve.API.JWTDecoder
{
    ...
    /// <summary>
    /// Client for the JWTDecoder API
    /// </summary>
    public class JWTDecoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/jwtdecoder";
        ...
        {
            { "token", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public JWTDecoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JWTDecoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JWTDecoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, JWTDecoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(JWTDecoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(JWTDecoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(JWTDecoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(JWTDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(JWTDecoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(JWTDecoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(JWTDecoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(JWTDecoderQueryOptions options)
        {
