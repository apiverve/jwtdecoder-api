...
class jwtdecoderWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"token":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/jwtdecoder`);
        }
    }
