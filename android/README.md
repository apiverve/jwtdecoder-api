...
```gradle
dependencies {
    implementation 'com.github.apiverve:jwtdecoder-api:1.1.13'
}
```
...
```java
import com.apiverve.jwtdecoder.JWTDecoderAPIClient;
import com.apiverve.jwtdecoder.APIResponse;
import com.apiverve.jwtdecoder.APIException;

// Initialize the client
JWTDecoderAPIClient client = new JWTDecoderAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/jwtdecoder](https://docs.apiverve.com/ref/jwtdecoder)
...
- **Documentation:** [https://docs.apiverve.com/ref/jwtdecoder](https://docs.apiverve.com/ref/jwtdecoder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/jwtdecoder-api/issues)
