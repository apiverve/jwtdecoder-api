// Package jwtdecoder provides a Go client for the JWT Decoder API.
//
// For more information, visit: https://apiverve.com/marketplace/jwtdecoder?utm_source=go&utm_medium=readme
package jwtdecoder
...
// Request contains the parameters for the JWT Decoder API.
//
// Parameters:
//   - token (required): string - JWT token to decode
type Request struct {
...
// ResponseData contains the data returned by the JWT Decoder API.
...
// HeaderData represents the header object.
type HeaderData struct {
	Alg string `json:"alg"`
	Typ string `json:"typ"`
}

// PayloadData represents the payload object.
