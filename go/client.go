...
const (
	baseURL        = "https://api.apiverve.com/v1/jwtdecoder"
	defaultTimeout = 30 * time.Second
)

// Client is the JWT Decoder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new JWT Decoder API client.
...
// Execute makes a request to the JWT Decoder API with typed parameters.
//
